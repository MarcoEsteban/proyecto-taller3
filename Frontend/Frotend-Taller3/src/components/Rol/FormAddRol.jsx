...
const FormAddRol = ({ link }) => {
    ...
    return (
        <div className="text-secundary-300 shadow-md bg-secundary-200 p-4 rounded-lg w-1/3 m-auto">
            <h1 className='text-2xl font-semibold text-gray-900 dark:text-secundary-300 flex justify-center'>Agregar Rol</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='flex gap-2'>
                    <Buton type='button' width="w-2/5" onClick={() => navigateLink()}>Cancelar</Buton>
